  ...
  return (
    <div className=' relative w-full min-h-screen overflow-hidden'>
      ...
      <div className='flex flex-col items-center w-full justify-center h-full'>
        <div className=' my-7 flex-warp max-md:flex-col w-full center gap-2'>
          ...
          <Link className=' buttonbg p-2 px-4 rounded-full' href={'/mail'}>View all mail</Link>
        </div>
      </div>
      <div className='flex flex-col items-center justify-center h-full'>
         <button className="max-md:text-xs border border-red-500/50 text-red-500/80 cursor-pointer rounded-4xl bg-red-400/10  p-2 max-md:px-3 px-5" onClick={() => signOut()}>Sign out</button>
      </div>
