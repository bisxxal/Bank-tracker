...
import { syncBankEmails } from "@/actions";
...
export default async function InboxPage() {
  ...
  //   // Sign out or show error
  //   signOut()
  // }
  if (!accessToken) {
    return (
      <div className=" flex w-full min-h-screen justify-center items-center flex-col">Please login to view emails .
